import { j as m } from "./jsx-runtime-56DGgGmo.js";
const _e = ({ fill: e = "white", variation: r = 1 }) =>
    r === 1 ? m.jsx(ie, { fill: e }) : m.jsx(le, {}),
  ie = ({ fill: e = "white" }) =>
    m.jsxs("svg", {
      width: "14px",
      height: "14px",
...
function ee(e) {
  ...
  if (typeof e == "string" || typeof e == "number") o += e;
    ...
    if (Array.isArray(e)) {
      var i = e.length;
      for (r = 0; r < i; r++)
        e[r] && (t = ee(e[r])) && (o && (o += " "), (o += t));
    } else for (t in e) e[t] && (o && (o += " "), (o += t));
  return o;
}
function ae() {
  for (var e, r, t = 0, o = "", i = arguments.length; t < i; t++)
    (e = arguments[t]) && (r = ee(e)) && (o && (o += " "), (o += r));
  return o;
}
const U = "-",
  ce = (e) => {
    ...
    return {
      getClassGroupId: (a) => {
        const s = a.split(U);
        return s[0] === "" && s.length !== 1 && s.shift(), re(s, r) || de(a);
      },
  ...
  re = (e, r) => {
    ...
    const t = e[0],
      o = r.nextPart.get(t),
      i = o ? re(e.slice(1), o) : void 0;
    if (i) return i;
    if (r.validators.length === 0) return;
    const n = e.join(U);
    return (a = r.validators.find(({ validator: s }) => s(n))) == null
      ? void 0
      : a.classGroupId;
  },
  Q = /^\[(.+)\]$/,
  ...
  pe = (e) => {
    ...
    return (
      be(Object.entries(e.classGroups), t).forEach(([n, a]) => {
        $(a, o, n, r);
      }),
      o
    );
      ...
      ? e.map(([t, o]) => {
          const i = o.map((n) =>
            typeof n == "string"
              ...
              : typeof n == "object"
              ? Object.fromEntries(
                  Object.entries(n).map(([a, s]) => [r + a, s])
                )
              : n
          );
          return [t, i];
  ...
  ge = (e) => {
    ...
    let r = 0,
      ...
      o = new Map();
    const i = (n, a) => {
      t.set(n, a), r++, r > e && ((r = 0), (o = t), (t = new Map()));
    };
    return {
      get(n) {
        let a = t.get(n);
        if (a !== void 0) return a;
        if ((a = o.get(n)) !== void 0) return i(n, a), a;
      },
      set(n, a) {
  ...
  fe = (e) => {
    const { separator: r, experimentalParseClassName: t } = e,
      ...
      a = (s) => {
        ...
        const C = u.length === 0 ? s : s.substring(h),
          v = C.startsWith(te),
          y = v ? C.substring(1) : C,
          b = w && w > h ? w - h : void 0;
        return {
    ...
    return t ? (s) => t({ className: s, parseClassName: a }) : a;
  },
  me = (e) => {
  ...
  he = (e) => ({ cache: ge(e.cacheSize), parseClassName: fe(e), ...ce(e) }),
  xe = /\s+/,
  we = (e, r) => {
    const {
        parseClassName: t,
...
function ye(e, ...r) {
  let t,
    ...
    n = a;
  function a(u) {
    const g = r.reduce((h, w) => w(h), e());
    return (t = he(g)), (o = t.cache.get), (i = t.cache.set), (n = s), s(u);
  }
  function s(u) {
    const g = o(u);
    if (g) return g;
...
const c = (e) => {
  ...
  k = (e) => A(e) || Le.has(e) || ve.test(e),
  M = (e) => S(e, "length", Ne),
  A = (e) => !!e && !Number.isNaN(Number(e)),
  O = (e) => S(e, "number", A),
  I = (e) => !!e && Number.isInteger(Number(e)),
  Se = (e) => e.endsWith("%") && A(e.slice(0, -1)),
  l = (e) => ne.test(e),
  z = (e) => ke.test(e),
  Ge = new Set(["length", "size", "percentage"]),
  Re = (e) => S(e, Ge, se),
  Ie = (e) => S(e, "position", se),
  Pe = new Set(["image", "url"]),
  Ze = (e) => S(e, Pe, Ve),
  Ee = (e) => S(e, "", Te),
  P = () => !0,
  S = (e, r, t) => {
  ...
  We = () => {
    ...
    return {
      ...
      theme: {
        ...
        gradientColorStopPositions: [Se, M],
        inset: W(),
        margin: W(),
        opacity: L(),
        padding: d(),
      ...
      classGroups: {
        ...
        grow: [{ grow: R() }],
        shrink: [{ shrink: R() }],
        order: [{ order: ["first", "last", "none", I, l] }],
        "grid-cols": [{ "grid-cols": [P] }],
        "col-start-end": [{ col: ["auto", { span: ["full", I, l] }, l] }],
        "col-start": [{ "col-start": E() }],
        "col-end": [{ "col-end": E() }],
        "grid-rows": [{ "grid-rows": [P] }],
        "row-start-end": [{ row: ["auto", { span: [I, l] }, l] }],
        ...
        w: [{ w: ["auto", "min", "max", "fit", "svw", "lvw", "dvw", l, r] }],
        "min-w": [{ "min-w": [l, r, "min", "max", "fit"] }],
        "max-w": [
          {
            "max-w": [
              l,
        ...
        h: [{ h: [l, r, "auto", "min", "max", "fit", "svh", "lvh", "dvh"] }],
        "min-h": [
        ...
        size: [{ size: [l, r, "auto", "min", "max", "fit"] }],
        "font-size": [{ text: ["base", z, M] }],
        ...
        "line-clamp": [{ "line-clamp": ["none", A, O] }],
        leading: [
          {
            leading: [
              "none",
        ...
        "bg-size": [{ bg: ["auto", "cover", "contain", Re] }],
        "bg-image": [
          {
            bg: [
              "none",
        ...
        "outline-w": [{ outline: [k, M] }],
        "outline-color": [{ outline: [e] }],
        "ring-w": [{ ring: H() }],
        "ring-w-inset": ["ring-inset"],
        "ring-color": [{ ring: [e] }],
        "ring-opacity": [{ "ring-opacity": [f] }],
        "ring-offset-w": [{ "ring-offset": [k, M] }],
        "ring-offset-color": [{ "ring-offset": [e] }],
        shadow: [{ shadow: ["", "inner", "none", z, Ee] }],
        ...
        contrast: [{ contrast: [u] }],
        "drop-shadow": [{ "drop-shadow": ["", "none", z, l] }],
...
const $e = ({ className: e = "" }) =>
  m.jsxs("svg", {
    ...
    height: "20px",
    viewBox: "0 0 24 24",
    className: _("fill-white", e),
    xmlns: "http://www.w3.org/2000/svg",
    children: [
      m.jsx("title", { children: "GitHub" }),
      m.jsx("path", {
