import { r, j as R } from "./jsx-runtime-56DGgGmo.js";
import {
  E as v,
  c as h,
  i as C,
  ...
  if (!t) {
    if (window.__remixContext.future.v3_singleFetch) {
      if (!n) {
        ...
        C(u, "No stream found for single fetch decoding"),
    ...
    if (!window.__remixContext.isSpaMode) {
      ...
      let u = g(i, window.location, window.__remixContext.basename);
      if (u)
        for (let l of u) {
          let _ = l.route.id,
          ...
          x &&
          E(m, x, window.__remixContext.isSpaMode) &&
    ...
    (t = F({
      ...
      future: {
        ...
        v7_skipActionErrorRevalidation:
          window.__remixContext.future.v3_singleFetch === !0,
      },
      hydrationData: o,
      mapRouteProperties: S,
      dataStrategy: window.__remixContext.future.v3_singleFetch
        ? k(window.__remixManifest, window.__remixRouteModules, () => t)
        : void 0,
      patchRoutesOnNavigation: P(
